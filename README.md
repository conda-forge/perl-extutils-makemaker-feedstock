...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/perl-extutils-makemaker-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14499&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/perl-extutils-makemaker-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `perl-extutils-makemaker` can be installed with:

```
conda install perl-extutils-makemaker
```

It is possible to list all of the versions of `perl-extutils-makemaker` available on your platform with:
